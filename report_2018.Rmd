...
author: "[Avision Ho](https://github.com/avisionh) and Chelsea Do Hyung Kim" 
date: "`r Sys.Date()`"
output:
...
**Most survey respondents answered that they have watched or expect to watch `r toString(txt_no_film)` films during LEAFF 2018 as they `r toString(txt_no_film_conc[2])`.**
