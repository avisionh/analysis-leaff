...
```{r (HIDE) 1.3 Motivation - text, echo = FALSE, include = FALSE}
txt_motivation <- data_no_film %>% 
...
```
```{r (SHOW) 1.3 Motivation - plot, echo = FALSE, fig.margin = TRUE, fig.cap = "Figure 7", fig.width = 5, fig.height = 4}
