...
## Section 1: Summary
Given the range of films screened, the way these screenings met accessibility requirements, and the additional events that were hosted during the festival to complement the films, then LEAF 2017 offered all audiences an eclectic range of activities and films to enjoy.

# Section 2: Audience Demographics
`r newthought("This section presents")` data on the demographics of people who have attended LEAF 2017, and filled in our post-screening surveys.
...
data_gender <- data_demographics %>% 
  filter(Category == "Gender" & !is.na(Value)) %>% 
...
func_plot_pie(x = data_gender, col_counts = "Percent", col_category = "Field", 
              plot_title = "Gender", factor_levels = c("prefer not to say / did not answer", "Male", "Female"))
```
...
+ In *Figure 2**, the largest age group is
