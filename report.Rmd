...
func_plot_counts_percents(x = data_rating, 
                          ...
                          plot_title_x = "How would you reate your experience of LEAFF 2019?")
```
+ In **Figure 1**, `r toString(paste0(txt_rating * 100, "%"))` of attendees rated their LEAFF 2018 experience as being **Very good** or **Good**.
...
**Survey respondents enjoyed LEAFF 2018 so much that `r toString(paste0(txt_rating * 100, "%"))` said their experience was *Very good* or *Good*.**
