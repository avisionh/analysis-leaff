...
func_plot_counts_percents(x = data_ethnicity,
                         ...
                         plot_title_x = "Ethnic Group")

```
+ In **Figure 2**, can see that the majority of the audience who attended LEAFF and completed the survey are of the `r toString(txt_ethnicity)` ethnic group.

+ This shows LEAFF is `r toString(txt_ethnicity_conc)` the attendance of ethnic minority groups..
