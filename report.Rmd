...
## Section 1.1: How much did the audience enjoy LEAFF 2018?
...
## Section 1.2: How likely are the audience to recommend LEAFF to friends and colleagues?
...
## Section 1.3: How many do screenings does our audience see?
...
## Section 1.4: Why does our audience come to LEAFF?
...
## Section 1.5: How many previous and new audiences came to LEAFF 2018?
```{r (SHOW) 1.5 Retention - plot, echo = FALSE, fig.margin = TRUE, fig.cap = "Figure 3", fig.width = 6, fig.height = 5}
