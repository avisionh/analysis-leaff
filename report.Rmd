---
title: "Analysis: How successful was LEAFF 2018?"
subtitle: "[London East Asia Film Festival (LEAFF) 2018](https://www.leaff.org.uk/)"
...
source("scripts/2018/2.3 - reportNumberFilms.R")
...
**`r toString(paste0(txt_rating * 100, "%"))` enjoyed LEAFF 2018 so much that will return for future editions of LEAFF.**

**`r toString(paste0(txt_recommend * 100, "%"))` enjoyed LEAFF 2018 so much that they would recommend a friend or colleague to attend LEAFF.**

**Most said that they have watched or expect to watch `r toString(txt_no_film)` films during LEAFF 2018 as they `r toString(txt_no_film_conc[2])`.**

***`r toString(txt_motivation)`* were the top three reasons why they wanted to attend LEAFF 2018.**
...
```
`r newthought("This section presents")` some of the comments made by audience members who have attended LEAFF 2018.

> _"Very positive, fascinating and varied films; informative discussion, nice atmosphere."_

> _"Pleasant and welcoming - good for going as a solo customer."_

> _"A great chance to see films you otherwise would not."_

> _"A meaningful and memorable experience."_

> _"Eye-opening; new but at home."_

> _"Intensive and inspiring"_

> _"Mind-opening"_

> `r quote_footer('--- LEAFF 2018 audience members')`
...
## Section 2.1: How much did the audience enjoy LEAFF 2018?
...
+ This demonstrates that `r toString(txt_rating_conc[1])` attendees enjoyed LEAFF 2018 and that the programme and activities which were part of this were `r toString(txt_rating_conc[2])` in capturing the public's interests and appetite for film and cinema.
...
+ This `r toString(txt_recommend_conc)` the findings made in *Section 1.1* where `r toString(paste0(txt_rating * 100, "%"))` of respondents said they were **Very likely** or **Likely** to attend future LEAFFs. 
...
## Section 2.3: How many do screenings does our audience see?
...
+ This `r toString(txt_no_film_conc[1])` the earlier findings that `r toString(paste0(txt_rating * 100, "%"))` of respondents were **Very likely** or **Likely** to return to future LEAFFs, which suggests they `r toString(txt_no_film_conc)`.

## Section 2.4: Why does our audience come to LEAFF?
+ Digging further into why `r toString(paste0(txt_rating * 100, "%"))` of survey respondents enjoyed their LEAFF experience such that they are **Very likely** or **Likely** to attend, we see the top three reasons for why they wanted to attend LEAFF were *`r toString(txt_motivation)`*.
...
## Section 2.5: How many previous and new audiences came to LEAFF 2018?
...
func_plot_pie(x = table_retention, col_counts = "Percent", col_category = "Choice_New", 
...
**Survey respondents enjoyed LEAFF 2018 so much that `r toString(paste0(txt_rating * 100, "%"))` of them will return for future editions of LEAFF.**

**Survey respondents enjoyed LEAFF 2018 so much that `r toString(paste0(txt_recommend * 100, "%"))` of them will recommend a friend or colleague to attend LEAFF.**

**Most survey respondents answered that they have watched or expect to watch `r toString(txt_no_film)` films during LEAFF 2018 as they `r toString(txt_no_film_conc)`.**

**The top three reasons for why survey respondents wanted to attend LEAFF were *`r toString(txt_motivation)`*.**

**`r toString(paste0(txt_retention_new * 100, "%"))` of survey respondents said this is their first time coming to the festival, showing that LEAFF was `r toString(txt_retention_stay[2])` in attracting new audience memebers and retaining previous members.**
