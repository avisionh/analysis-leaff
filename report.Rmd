...
txt_film_titles <- data_activity_fund %>% 
  ...
  pull()
txt_film_titles <- paste0(txt_film_titles[1:4], sep = ", ", txt_film_titles[5])

# Create text for film screenings
txt_film_screenings <- data_activity_fund %>% 
  distinct(VenueName)
txt_film_screenings <- paste0(txt_film_screenings[1:3], sep = ", ", txt_film_screenigns[8])
  
```

For the 2017 festival a wide range of films from different nations that included South Korea, Japan, Hong Kong, Vietnam, and the Phillippines were shown. ^[[Full programme](https://www.leaff.org.uk/programme-2/)] These included `r toString(txt_film_titles)`. 
